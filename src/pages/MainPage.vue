        ...
        <v-container>
          <v-row justify="space-around" class="header-menu">
            ...
            <v-dialog v-model="NewPersonVisible" width="auto" height="500px" scrollable>
              ...
              <v-card>
                <v-card-text style="height: 300px;">
                  <new-person @add="addPerson" :persons="persons" @deletePerson="deletePerson"></new-person></v-card-text>
                <v-divider></v-divider>
              </v-card>
            </v-dialog>
            <v-dialog v-model="TotalAmountVisible" width="auto" scrollable >
              ...
              <v-card>
                <total-amount @create="createCard" :persons="persons" @removeRepetitions="removeRepetitions"></total-amount></v-card>
            </v-dialog>
          </v-row>
        </v-container>
